...
static const char* TestGPURayCastCameraInsideTransformationNoShadeNoGradOpLog =
  "# StreamVersion 1\n"
  "EnterEvent 298 27 0 0 0 0 0\n"
  "MouseWheelForwardEvent 200 142 0 0 0 0 0\n"
  "LeaveEvent 311 71 0 0 0 0 0\n";

int TestGPURayCastCameraInsideTransformationNoShadeNoGradOp(int argc, char* argv[])
{
  ...
  int rv =
    vtkTesting::InteractorEventLoop(argc, argv, iren, TestGPURayCastCameraInsideTransformationNoShadeNoGradOpLog);
  return rv;
}
