...
/// near plane while the camera is inside the volume. The ray step is refined
/// (4x more samples) to test whether the near-silhouette first-sample handling
/// is the source of the Metal/OpenGL divergence.
...
static const char* TestGPURayCastCameraInsideTransformationNoShadeNoGradOpNoTransformFineStepLog =
  "# StreamVersion 1\n"
  "EnterEvent 298 27 0 0 0 0 0\n"
  "MouseWheelForwardEvent 200 142 0 0 0 0 0\n"
  "LeaveEvent 311 71 0 0 0 0 0\n";

int TestGPURayCastCameraInsideTransformationNoShadeNoGradOpNoTransformFineStep(
  int argc, char* argv[])
{
  ...
  // 4x more samples than the default (SampleDistance 1.0 -> 0.25)
  ...
  int rv = vtkTesting::InteractorEventLoop(
    argc, argv, iren, TestGPURayCastCameraInsideTransformationNoShadeNoGradOpNoTransformFineStepLog);
  return rv;
}
