...
static const char* TestGPURayCastCameraInsideTransformationSampleDist0_5Log =
  "# StreamVersion 1\n"
  "EnterEvent 298 27 0 0 0 0 0\n"
  "MouseWheelForwardEvent 200 142 0 0 0 0 0\n"
  "LeaveEvent 311 71 0 0 0 0 0\n";

int TestGPURayCastCameraInsideTransformationSampleDist0_5(int argc, char* argv[])
{
  ...
  int rv =
    vtkTesting::InteractorEventLoop(argc, argv, iren, TestGPURayCastCameraInsideTransformationSampleDist0_5Log);
  return rv;
}
