...
static const char* TestGPURayCastCameraInsideTransformationSampleDist0_25Log =
  "# StreamVersion 1\n"
  "EnterEvent 298 27 0 0 0 0 0\n"
  "MouseWheelForwardEvent 200 142 0 0 0 0 0\n"
  "LeaveEvent 311 71 0 0 0 0 0\n";

int TestGPURayCastCameraInsideTransformationSampleDist0_25(int argc, char* argv[])
{
  ...
  int rv =
    vtkTesting::InteractorEventLoop(argc, argv, iren, TestGPURayCastCameraInsideTransformationSampleDist0_25Log);
  return rv;
}
