...
/// Description:
/// Variant of TestGPURayCastCameraInsideTransformation with shading disabled,
/// used to isolate lighting from the opacity/accumulation path when comparing
/// the Metal and OpenGL backends.
...
static const char* TestGPURayCastCameraInsideTransformationNoShadeLog =
  "# StreamVersion 1\n"
  "EnterEvent 298 27 0 0 0 0 0\n"
  "MouseWheelForwardEvent 200 142 0 0 0 0 0\n"
  "LeaveEvent 311 71 0 0 0 0 0\n";

int TestGPURayCastCameraInsideTransformationNoShade(int argc, char* argv[])
{
  // Load data
  ...
  int rv = vtkTesting::InteractorEventLoop(
    argc, argv, iren, TestGPURayCastCameraInsideTransformationNoShadeLog);
  return rv;
}
