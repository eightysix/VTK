...
/// Description:
/// Variant of TestGPURayCastCameraInsideTransformationNoShade with a gentle
/// linear gradient-opacity ramp (0@0 to 1@2000) instead of the steep step
/// near the low end. Any gradient-magnitude error between Metal and OpenGL
/// now scales the per-sample opacity proportionally instead of being clipped
/// by a near-step, exposing where the divergence lives.
...
static const char* TestGPURayCastCameraInsideTransformationNoShadeLinGradOpLog =
  "# StreamVersion 1\n"
  "EnterEvent 298 27 0 0 0 0 0\n"
  "MouseWheelForwardEvent 200 142 0 0 0 0 0\n"
  "LeaveEvent 311 71 0 0 0 0 0\n";

int TestGPURayCastCameraInsideTransformationNoShadeLinGradOp(int argc, char* argv[])
{
  // Load data
  ...
  int rv = vtkTesting::InteractorEventLoop(
    argc, argv, iren, TestGPURayCastCameraInsideTransformationNoShadeLinGradOpLog);
  return rv;
}
