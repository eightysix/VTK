...
/// Description:
/// Tests ray casting of a volume (no vtkProp3D transformation) with the camera
/// outside the volume (no near-plane clipping).
...
static const char* TestGPURayCastCameraInsideTransformationNoShadeNoGradOpNoTransformCamOutsideLog =
  "# StreamVersion 1\n"
  "EnterEvent 298 27 0 0 0 0 0\n"
  "MouseWheelForwardEvent 200 142 0 0 0 0 0\n"
  "LeaveEvent 311 71 0 0 0 0 0\n";

int TestGPURayCastCameraInsideTransformationNoShadeNoGradOpNoTransformCamOutside(int argc, char* argv[])
{
  ...
  int rv = vtkTesting::InteractorEventLoop(
    argc, argv, iren, TestGPURayCastCameraInsideTransformationNoShadeNoGradOpNoTransformCamOutsideLog);
  return rv;
}
