...
- **Branch:** `metal-volume-parity-essential e05a147fb5` `6-fetch central` `thr fallback analytic 0.15` `y-transpose` default off for `512` fallback, `BASE` below default on for `512` real volumes
...
# VolumeRayCast 1160 thr 3.32 y, DICOM 1122 thr 0.000 y, NIFTI 3797 thr 2.93 y at 512
...
### 2.1 `512 y` correct `BASE` (`e05a147fb5` `6-fetch`)

```
VolumeRayCast y 1160 thr 3.32 (was 1507 with 4-fetch, 0.15 without y)
DICOMVolume y 1122 thr 0.000
NIFTIVolume y 3797 thr 2.93
